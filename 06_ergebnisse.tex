...
%	\end{footnotesize}
	...
	\begin{table}[h!]
		...
		\label{tab:Messreihen_ausreißer}
		\resizebox{15cm}{!}{
	...
	\vspace*{-5mm}
	  ...
	  \begin{table}[h!]
	  	...
	  	\begin{tabulary}{1.3\textwidth}{L|C|C|C||C|C}
	  		...
	  		\hline
	  		\hline
	  		$\bar{c}$&\SI{6,472}{\milli\gram\per\liter}&\SI{6,697}{\milli\gram\per\liter}&\SI{6,606}{\milli\gram\per\liter}&\SI{6,591}{\milli \gram \per \liter}&\SI{0,0925}{\milli \gram \per \liter}\\
	  		\hline
	  ...
	  Für die Berechnungen des Mittelwertes und der Standardabweichung siehe Gl. ...
	  \begin{flalign}
	  	conf(\bar{x}) 	&= \bar{x}\pm \frac{t}{\sqrt{N}}*s				
	  \end{flalign}
	   \begin{flalign}
	  	conf(\bar{x})	&= \SI{6,591}{\milli \gram \per \liter}\pm \frac{4,303}{\sqrt{3}}*\SI{0,0925}{\milli \gram \per \liter}\\
	  					&= \underline{\SI{6,591}{\milli \gram \per \liter}\pm \SI{0,230}{\milli \gram \per \liter}}
	  \end{flalign}
	...
	m_{\text{original}} 	&= m_{\text{mess}} *f_A\\
	m_{\text{original}} 	&= V_{\text{mess}} *c*f_A\\
							&= \SI{25e-3}{\liter} *\left(\SI{6,591}{\milli \gram \per \liter}\pm \SI{0,230}{\milli \gram \per \liter}\right)*4\\
	m_{\text{original}} 	&=\SI{0,659}{\milli \gram}\pm \SI{0,0230}{\milli \gram}
	 = \underline{\SI{659,1}{\micro \gram}\pm \SI{23,0}{\milli \gram}}\\
	\end{flalign}
