...
%	\FloatBarrier
	...
	--> Stark unterschiedliche Messwerte, Neue Betrachtung nötig
...
%	\end{footnotesize}
	...
	\begin{table}[h!]
		...
		\resizebox{17cm}{!}{
		\begin{tabulary}{1.4\textwidth}{C|C|C|C}
			\hline
	...
	\textcolor{red}{Neue Kalibrierkurve }
	  ...
	  \begin{table}[h!]
	  	...
	  	\begin{tabulary}{\textwidth}{L|C|C|C}
	  		\hline
	  	&\textbf{Computer}&\textbf{Manuell einzeln}&\textbf{Manuell}\\
	  		\hline
	  		\hline
		  	Messung 1&\SI{5,757}{\milli\gram\per\liter}&\SI{5,906}{\milli\gram\per\liter}&\\
	  		\hline
	  		Messung 2&\SI{7,186}{\milli\gram\per\liter}&\SI{7,487}{\milli\gram\per\liter}&\\
	  		\hline
	  	\end{tabulary}
	  	%}
	  \end{table}
	  ...
	  Tabelle mit Massen aus Computer Manuell einzeln und Manuell + Mittelwert + Standardabweichung + Vertrauensbereich
